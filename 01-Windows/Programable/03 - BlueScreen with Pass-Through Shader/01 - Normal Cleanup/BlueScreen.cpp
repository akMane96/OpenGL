...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	ASM_hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		ASM_szAppName,
		TEXT("OpenGL Programmable Pipeline BlueScreen with Empty Shaders"),
		WS_OVERLAPPEDWINDOW,
...
void UnInitialize()
{
	...
	glDetachShader(ASM_gShaderProgramObject, ASM_gVertexShaderObject);

	glDetachShader(ASM_gShaderProgramObject, ASM_gFragmentShaderObject);

	glDeleteShader(ASM_gVertexShaderObject);
	ASM_gVertexShaderObject = 0;

	glDeleteShader(ASM_gFragmentShaderObject);
	ASM_gFragmentShaderObject = 0;
