...
void Initialize()
{
	...
	loadGLTexture(&ASM_smileyTexture, MAKEINTRESOURCE(ASM_SMILEY_BITMAP));
...
void Display()
{
	...
	glUseProgram(ASM_shaderProgramObject);
		...
		glBindVertexArray(ASM_vao_Square);
			...
			if (ASM_PressedKey == 1)
			{
				ASM_squareTexArray[0] = 1.0f;	ASM_squareTexArray[1] = 1.0f;
				ASM_squareTexArray[2] = 0.0f;	ASM_squareTexArray[3] = 1.0f;
				ASM_squareTexArray[4] = 0.0f;	ASM_squareTexArray[5] = 0.0f;
				ASM_squareTexArray[6] = 1.0f;	ASM_squareTexArray[7] = 0.0f;
			...
			} else if (ASM_PressedKey == 2)
			{
				...
				ASM_squareTexArray[4] = 0.0f;	ASM_squareTexArray[5] = 0.0f;
				ASM_squareTexArray[6] = 0.5f;	ASM_squareTexArray[7] = 0.0f;

			}
			else if (ASM_PressedKey == 3)
			{
				ASM_squareTexArray[0] = 2.0f;	ASM_squareTexArray[1] = 2.0f;
				ASM_squareTexArray[2] = 0.0f;	ASM_squareTexArray[3] = 2.0f;
				ASM_squareTexArray[4] = 0.0f;	ASM_squareTexArray[5] = 0.0f;
				ASM_squareTexArray[6] = 2.0f;	ASM_squareTexArray[7] = 0.0f;
