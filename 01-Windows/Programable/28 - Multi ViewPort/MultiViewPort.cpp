...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	void Resize(int, int);
	void UnInitialize();
	static int ASM_width, ASM_height;
	...
	case WM_KEYDOWN:
		...
		switch (wParam)
		{
			...
			case 0x30:
			case VK_NUMPAD0:
				glViewport(0, 0, (GLsizei)ASM_width, (GLsizei)ASM_height);
				break;

			case 0x31:
			case VK_NUMPAD1:
				glViewport(0, (GLsizei)(ASM_height / 2), (GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2));
				break;

			case 0x32:
			case VK_NUMPAD2:
				glViewport((GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2), (GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2));
				break;

			case 0x33:
			case VK_NUMPAD3:
				glViewport((GLsizei)(ASM_width / 2), 0, (GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2));
				break;

			case 0x34:
			case VK_NUMPAD4:
				glViewport(0, 0, (GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2));
				break;

			case 0x35:
			case VK_NUMPAD5:
				glViewport(0, 0, (GLsizei)(ASM_width / 2), (GLsizei)ASM_height);
				break;

			case 0x36:
				//case VK_NUMPAD6:
				glViewport((GLsizei)(ASM_width / 2), 0, (GLsizei)(ASM_width / 2), (GLsizei)ASM_height);
				break;

			case 0x37:
			case VK_NUMPAD7:
				glViewport(0, (GLsizei)(ASM_height / 2), (GLsizei)ASM_width, (GLsizei)(ASM_height / 2));
				break;

			case 0x38:
			case VK_NUMPAD8:
				glViewport(0, 0, (GLsizei)ASM_width, (GLsizei)(ASM_height / 2));
				break;

			case 0x39:
			case VK_NUMPAD9:
				glViewport((GLsizei)(ASM_width / 4), (GLsizei)(ASM_height / 4), (GLsizei)(ASM_width / 2), (GLsizei)(ASM_height / 2));
				break;
