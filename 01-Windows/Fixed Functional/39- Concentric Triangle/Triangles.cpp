...
void Display()
{
	GLfloat ASM_inc = 0.0f;
	//funation declration
	void Triangle(GLfloat, GLfloat, GLfloat, GLfloat);
	...
	Triangle(1.0f,0.0f,0.0f, ASM_inc++);
	Triangle(0.0f, 1.0f, 0.0f, ASM_inc++);
	Triangle(0.0f, 0.0f, 1.0f, ASM_inc++);
	Triangle(0.0f, 1.0f, 1.0f, ASM_inc++);
	Triangle(1.0f, 0.0f, 1.0f, ASM_inc++);
	Triangle(1.0f, 1.0f, 0.0f, ASM_inc++);
	Triangle(1.0f, 1.0f, 1.0f, ASM_inc++);
	Triangle(0.5f, 0.5f, 0.5f, ASM_inc++);
	Triangle(1.0f, 0.5f, 0.0f, ASM_inc++);
	Triangle(1.0f, 0.4f, 0.7f, ASM_inc++);
	
	SwapBuffers(ASM_ghdc);

}

void Triangle(GLfloat red,GLfloat green,GLfloat blue,GLfloat ASM_inc)
{
	//varaiable declaration
	GLfloat ASM_rootThree = sqrtf(3.0f) - 1.0f;

	glBegin(GL_LINES);
	glColor3f(red, green, blue);
	glVertex3f(0.0f, (ASM_rootThree + ASM_inc), 0.0f);
	glVertex3f((-1.0f - ASM_inc), (-1.0f - ASM_inc), 0.0f);
	glEnd();
