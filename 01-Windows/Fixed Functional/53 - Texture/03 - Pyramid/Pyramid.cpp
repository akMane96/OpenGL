...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	ASM_hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		ASM_szAppName,
		TEXT("Akshay Texture Pyramid OpenGL"),
		WS_OVERLAPPEDWINDOW,
...
void Initialize()
{
	//Local Function Declaration
	void Resize(int, int);
	bool glLoadTexture(GLuint* , TCHAR[]);
	...
	glLoadTexture(&ASM_Stone_texture, MAKEINTRESOURCE(ASM_STONE_BITMAP));
...
bool glLoadTexture(GLuint* texture, TCHAR resourceId[])
{

	//varaiabled declaration
