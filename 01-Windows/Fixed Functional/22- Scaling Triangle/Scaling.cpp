...
GLfloat ASM_xScale = 0.0f;
GLfloat ASM_yScale = 0.0f;
GLfloat ASM_zScale = 0.0f;
...
void Display()
{
	...
	glScalef(ASM_xScale, ASM_yScale, ASM_zScale);
...
void update()
{
	ASM_xScale = ASM_xScale + 0.0001f;
	ASM_yScale = ASM_yScale + 0.0001f;
	ASM_zScale = ASM_zScale + 0.0001f;
