...
void Display()
{
	...
	//funation declration
	void Rectangle(GLfloat, GLfloat, GLfloat, GLfloat);
	...
	Rectangle(1.0f,0.0f,0.0f, ASM_inc++);
	Rectangle(0.0f, 1.0f, 0.0f, ASM_inc++);
	Rectangle(0.0f, 0.0f, 1.0f, ASM_inc++);
	Rectangle(0.0f, 1.0f, 1.0f, ASM_inc++);
	Rectangle(1.0f, 0.0f, 1.0f, ASM_inc++);
	Rectangle(1.0f, 1.0f, 0.0f, ASM_inc++);
	Rectangle(1.0f, 1.0f, 1.0f, ASM_inc++);
	Rectangle(0.5f, 0.5f, 0.5f, ASM_inc++);
	Rectangle(1.0f, 0.5f, 0.0f, ASM_inc++);
	Rectangle(1.0f, 0.4f, 0.7f, ASM_inc++);
	
	SwapBuffers(ASM_ghdc);

}

void Rectangle(GLfloat red,GLfloat green,GLfloat blue,GLfloat ASM_inc)
{
