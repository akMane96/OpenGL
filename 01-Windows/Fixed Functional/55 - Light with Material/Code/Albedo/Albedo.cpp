...
GLfloat ASM_lightAmbient[] = { 0.1f, 0.1f, 0.1f , 1.0f};
GLfloat ASM_lightDiffiuse[] = { 1.0f, 1.0f , 1.0f, 1.0f};
...
GLfloat ASM_materialDiffuse[] = { 0.5f, 0.2f , 0.7f, 1.0f};
GLfloat ASM_materialSpecular[] = { 0.7f, 0.7f , 0.7f, 1.0f};
...
void Initialize()
{
	...
	glLightfv(GL_LIGHT1, GL_DIFFUSE, ASM_lightDiffiuse);
...
void Display()
{
	...
	gluSphere(ASM_quadric, 0.2f, 50, 50);

	//// Normals are calulated by gluSpehre itself
