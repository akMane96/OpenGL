...
GLuint ASM_texture_stone;
GLuint ASM_texture_kundali;
...
void Initialize(){
	...
	ASM_texture_stone = loadBitmapAsTexture("Stone.bmp");
	ASM_texture_kundali = loadBitmapAsTexture("Vijay_Kundali.bmp");
...
void Cube(){
	...
	glBindTexture(GL_TEXTURE_2D, ASM_texture_kundali);
...
void Pyramid()
{
	...
	glBindTexture(GL_TEXTURE_2D, ASM_texture_stone);
	//front triangle
...
void Uninitialize(){
	...
	if (ASM_texture_kundali)
	{
		glDeleteTextures(1, &ASM_texture_kundali);
	}
	
	if (ASM_texture_stone)
	{
		glDeleteTextures(1, &ASM_texture_stone);
	}
