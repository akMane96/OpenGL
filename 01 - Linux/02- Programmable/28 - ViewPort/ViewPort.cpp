				...
				case KeyPress:
					...
					switch(ASM_keysym)
					{
						...
						case XK_F:
							...
							case XK_0:
							glViewport(0, 0, (GLsizei)ASM_winWidth, (GLsizei)ASM_winHeight);
							break;
							
							case XK_1:
							glViewport(0, (GLsizei)(ASM_winHeight /2), (GLsizei)(ASM_winWidth /2), (GLsizei)(ASM_winHeight /2));
								break;
								
							case XK_2:
							glViewport((GLsizei)(ASM_winWidth / 2), (GLsizei)(ASM_winHeight / 2), (GLsizei)(ASM_winWidth / 2), (GLsizei)(ASM_winHeight / 2));
								break;
							
							case XK_3:
								glViewport((GLsizei)(ASM_winWidth / 2), 0 , (GLsizei)(ASM_winWidth / 2), (GLsizei)(ASM_winHeight / 2));
								break;
								
							case XK_4:
							glViewport(0, 0, (GLsizei)(ASM_winWidth / 2), (GLsizei)(ASM_winHeight / 2));
								break;
								
							case XK_5:
							glViewport(0, 0, (GLsizei)(ASM_winWidth / 2), (GLsizei)ASM_winHeight);
								break;
								
							case XK_6:
							glViewport((GLsizei)(ASM_winWidth / 2), 0, (GLsizei)(ASM_winWidth / 2), (GLsizei)ASM_winHeight);
								break;
								
							case XK_7:
							glViewport(0, (GLsizei)(ASM_winHeight / 2), (GLsizei)ASM_winWidth, (GLsizei)(ASM_winHeight / 2));
								break;
								
							case XK_8:
							glViewport(0, 0, (GLsizei)ASM_winWidth, (GLsizei)(ASM_winHeight / 2));
								break;
								
							case XK_9:
							glViewport((GLsizei)(ASM_winWidth / 4), (GLsizei)(ASM_winHeight / 4), (GLsizei)(ASM_winWidth / 2), (GLsizei)(ASM_winHeight / 2));
								break;
...
void Initialize(){
	...
	glBindVertexArray(ASM_vao);
		...
		glGenBuffers(1, &ASM_vbo_Position);
		glBindBuffer(GL_ARRAY_BUFFER, ASM_vbo_Position);
...
void Uninitialize(){
	...
	if (ASM_vbo_Position)
	{
		glDeleteBuffers(1, &ASM_vbo_Position);
		ASM_vbo_Position = 0;
	}
